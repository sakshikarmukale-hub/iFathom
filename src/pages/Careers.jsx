...
const condensedFont = "'Oswald', sans-serif";
    ...
    >
      <Box sx={{ flex: 1, minWidth: 0 }}>
        ...
        <Stack direction="row" alignItems="center" spacing={0.7} sx={{ mb: 0.5 }}>
          <PlaceIcon sx={{ fontSize: 16, color: colors.accent }} />
          <Typography sx={{ fontSize: "0.85rem", color: colors.navy }}>
            {flags}
          </Typography>
        </Stack>

        <Typography sx={{ fontSize: "0.85rem", color: colors.navy, mb: 1 }}>
...
export default function Careers() {
  return (
    <Box>
      ...
      >
        <Container maxWidth="lg">
          ...
          >
            Grow with
            <br />
            <Box component="span" sx={{ fontSize: { xs: "3.2rem", sm: "4.2rem", md: "5.2rem" } }}>
              iFathom
            </Box>
          </Typography>
        </Container>
      ...
      {/* ── Do your life's best work section ── */}
      <Box
        sx={{
...
<Box
  sx={{
    position: "relative",
    backgroundImage: `linear-gradient(rgba(5,15,35,0.75), rgba(5,15,35,0.75)), url(${HERO_BG})`,
